...
function GenerateSentences() {
	...
	nbrPhrase = randomNumberSentences(minPhrases, sentences.length, nbrMoyenPhrases, 8);
...
function onKeydown(e) {
	...
	if (e.keyCode == 116 || e.keyCode == 82){
		...
		document.getElementById("main-txt").innerHTML = "";
		ChangeBackground();
		TIMEOUT = setTimeout(GenerateSentences, 800 + 400*Math.random());
	}
