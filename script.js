...
function onKeydown(e) {
	...
	if (e.keyCode == 116 || e.keyCode == 82){
		...
		document.getElementById("main-txt").innerHTML = "";
		ChangeBackground();
		TIMEOUT = setTimeout(GenerateSentences, 500 + 800*Math.random());
	}
